 ...
 * @param bolder 是否加粗
 */
export const colorful = function (content: string | number, colorName: Color|null = null, bold = false): string {
 ...
 * @param notify 是否发送邮件
 */
export function log (content: string, prefix = '', color: Color|null = null, notify = false): void {
    // 有前缀就组装在一起
